...
def seed_defaults(connection):
    legacy_doctors = connection.execute(
        """
        SELECT COUNT(*)
        FROM doctors
        WHERE full_name IN ('Иванов Сергей', 'Петрова Анна', 'Сидоров Алексей', 'Кузнецова Мария')
        """
    ).fetchone()[0]
    current_doctors = connection.execute(
        """
        SELECT COUNT(*)
        FROM doctors
        WHERE full_name IN ('Салюк Е.А.', 'Малышева Н.Ф.', 'Суханова Е.Г.')
        """
    ).fetchone()[0]
    if legacy_doctors and not current_doctors:
        connection.execute("DELETE FROM doctor_services")
    ...
    if specialties_count == 0:
        specialties = [('Гинеколог', 'gynecologist'),
         ('Дерматовенеролог', 'dermatovenereologist'),
         ('Кардиолог', 'cardiologist'),
         ('Массажист', 'massage'),
         ('Невролог', 'neurologist'),
         ('Оториноларинголог', 'otolaryngologist'),
         ('Терапевт', 'therapist'),
         ...
         ('Аллерголог', 'alergolog'),
         ('Гастроэнтеролог', 'gastro')]
    ...
    if doctors_count == 0:
        doctors = [('Салюк Е.А.',
          ...
          'gynecologist',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779290833944.jpg'),
         ('Салюк Л.С.',
          'Гинеколог',
          'gynecologist',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779290926227.jpg'),
         ('Малышева Н.Ф.',
          'Дерматовенеролог',
          ...
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779290959734.jpg'),
         ('Суханова Е.Г.',
          'Кардиолог',
          'cardiologist',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779291062879.jpg'),
         ('Невоструев А.В.',
          'Массажист',
          'massage',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779291220291.jpg'),
         ('Горшков А.В.',
          'Невролог',
          'neurologist',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779291364781.jpg'),
         ('Смирнов С.В.',
          'Оториноларинголог',
          'otolaryngologist',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779291400056.jpg'),
         ('Долженко Г.С.',
          'Терапевт',
          'therapist',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779291431233.jpg'),
         ('Горшков А.В.',
          'Травматолог',
          'traumatologist',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779291465217.jpg'),
         ('Борцов М.Ю.',
          'УЗИ',
          'ultrasound',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779291496422.jpg'),
         ('Башлачёв В.А.',
          'Уролог',
          'urologist',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779291523884.jpg'),
         ('Борцов М.Ю.',
          'Хирург',
          'surgeon',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779291555087.jpg'),
         ('Ароян С.А.',
          'Эндокринолог',
          'endocrinologist',
          '10 лет',
          'Опытный специалист, ведущий консультативный прием, диагностику и лечение пациентов в соответствии с современными медицинскими '
          'стандартами. Индивидуальный подход, внимательное отношение и профессиональная помощь на каждом этапе лечения.',
          'uploads/doctors/doctor-1779291582567.jpg')]
        connection.executemany(
            """
    ...
    if services_count == 0:
        services = [('Консультация аллерголога',
          'Консультация у специалиста по аллергическим заболеваниям.',
          'Прием аллерголога с оценкой симптомов, разбором возможных причин аллергии и рекомендациями по диагностике, лечению и профилактике обострений.',
          1000,
          'uploads/services/service-1779287199986.png',
          'consultation'),
         ('Консультация гастроэнтеролога', '', '', 1100, 'uploads/services/service-1779288531832.png', 'consultation'),
         ('Биопсия шейки матки', '', '', 2500, 'uploads/services/service-1779288595522.png', 'treatment'),
         ('Введение маточного кольца при НМТД', '', '', 600, 'uploads/services/service-1779288658460.png', 'treatment'),
         ('Допплерометрия', '', '', 1200, 'uploads/services/service-1779288703902.png', 'treatment'),
         ('Постановка ВМС', '', '', 1800, 'uploads/services/service-1779288745100.png', 'treatment'),
         ('Удаление ВМС без проводника', '', '', 2300, 'uploads/services/service-1779288776409.png', 'treatment'),
         ('Удаление ВМС за проводник', '', '', 1500, 'uploads/services/service-1779288806239.png', 'treatment'),
         ('УЗИ беременные с 14 по 28 недель', '', '', 1800, 'uploads/services/service-1779288882303.png', 'diagnostics'),
         ('УЗИ беременные с 30 недели', '', '', 2000, 'uploads/services/service-1779288934848.png', 'diagnostics'),
         ('Консультация дерматовенеролога', '', '', 1400, 'uploads/services/service-1779289009341.png', 'consultation'),
         ('Азот ладони', '', '', 550, 'uploads/services/service-1779289064980.png', 'treatment'),
         ('Азот лицо', '', '', 650, 'uploads/services/service-1779289091625.png', 'treatment'),
         ('Азот туловище', '', '', 650, 'uploads/services/service-1779289202531.png', 'treatment'),
         ('ЭКГ с описанием', '', '', 700, 'uploads/services/service-1779289267057.png', 'cardio'),
         ('ЭХО КГ', '', '', 2000, 'uploads/services/service-1779289332462.png', 'cardio'),
         ('Массаж спины', '', '', 800, 'uploads/services/service-1779289527079.png', 'treatment'),
         ('Общий массаж', '', '', 1500, 'uploads/services/service-1779289550822.png', 'treatment'),
         ('Блокада', '', '', 500, 'uploads/services/service-1779289626085.png', 'treatment'),
         ('Консультация невролога', '', '', 1400, 'uploads/services/service-1779289657167.png', 'consultation'),
         ('Внутриносовая блокада', '', '', 1200, 'uploads/services/service-1779289730035.png', 'treatment'),
         ('Снятие швов лицо', '', '', 1500, 'uploads/services/service-1779289767082.png', 'treatment'),
         ('Врачебная комиссия', '', '', 400, 'uploads/services/service-1779289849691.png', 'diagnostics'),
         ('Выписка из амбулаторной карты', '', '', 1300, 'uploads/services/service-1779289876529.png', 'consultation'),
         ('Травматолог-ортопед', '', '', 1400, 'uploads/services/service-1779289928842.png', 'consultation'),
         ('Блокады травматолога (в т.ч. внутрисуставные)', '', '', 500, 'uploads/services/service-1779289972735.png', 'treatment'),
         ('УЗИ лимфоузлы', '', '', 600, 'uploads/services/service-1779290018069.png', 'diagnostics'),
         ('УЗИ ОМТ (дети)', '', '', 1100, 'uploads/services/service-1779290052715.png', 'diagnostics'),
         ('УЗИ Слюнные железы', '', '', 600, 'uploads/services/service-1779290086954.png', 'diagnostics'),
         ('Урофлуометрия', '', '', 350, 'uploads/services/service-1779290143172.png', 'diagnostics'),
         ('Консультация уролога', '', '', 1400, 'uploads/services/service-1779290198555.png', 'consultation'),
         ('Перевязка', '', '', 250, 'uploads/services/service-1779290241753.png', 'treatment'),
         ('Консультация хирурга', '', '', 1400, 'uploads/services/service-1779290298153.png', 'consultation'),
         ('Пункционная биопсия щ/ж 1 зона', '', '', 1535, 'uploads/services/service-1779290347614.png', 'treatment'),
         ('Пункционная биопсия щ/ж 2 зоны', '', '', 3320, 'uploads/services/service-1779290366861.png', 'treatment')]
        connection.executemany(
            """
    ...
    if "specialty_id" in service_columns:
        ...
        assignments = {'Консультация аллерголога': 'gastro',
             'Консультация гастроэнтеролога': 'gastro',
             'Биопсия шейки матки': 'gynecologist',
             'Введение маточного кольца при НМТД': 'gynecologist',
             'Допплерометрия': 'gynecologist',
             'Постановка ВМС': 'gynecologist',
             'Удаление ВМС без проводника': 'gynecologist',
             'Удаление ВМС за проводник': 'gynecologist',
             'УЗИ беременные с 14 по 28 недель': 'gynecologist',
             'УЗИ беременные с 30 недели': 'gynecologist',
             'Консультация дерматовенеролога': 'dermatovenereologist',
             'Азот ладони': 'dermatovenereologist',
             'Азот лицо': 'dermatovenereologist',
             'Азот туловище': 'dermatovenereologist',
             'ЭКГ с описанием': 'cardiologist',
             'ЭХО КГ': 'cardiologist',
             'Массаж спины': 'massage',
             'Общий массаж': 'massage',
             'Блокада': 'neurologist',
             'Консультация невролога': 'neurologist',
             'Внутриносовая блокада': 'otolaryngologist',
             'Снятие швов лицо': 'otolaryngologist',
             'Врачебная комиссия': 'therapist',
             'Выписка из амбулаторной карты': 'therapist',
             'Травматолог-ортопед': 'traumatologist',
             'Блокады травматолога (в т.ч. внутрисуставные)': 'traumatologist',
             'УЗИ лимфоузлы': 'ultrasound',
             'УЗИ ОМТ (дети)': 'ultrasound',
             'УЗИ Слюнные железы': 'ultrasound',
             'Урофлуометрия': 'urologist',
             'Консультация уролога': 'urologist',
             'Перевязка': 'surgeon',
             'Консультация хирурга': 'surgeon',
             'Пункционная биопсия щ/ж 1 зона': 'endocrinologist',
             'Пункционная биопсия щ/ж 2 зоны': 'endocrinologist'}
    ...
    if links_count == 0:
        doctor_map = {
            (row["full_name"], row["specialty_name"]): row["id"]
            for row in connection.execute("SELECT id, full_name, specialty_name FROM doctors").fetchall()
        }
        service_map = {
            row["name"]: row["id"]
            for row in connection.execute("SELECT id, name FROM services").fetchall()
        }
        links = [('Салюк Е.А.', 'Гинеколог', 'Постановка ВМС'),
             ('Салюк Е.А.', 'Гинеколог', 'Удаление ВМС без проводника'),
             ('Салюк Е.А.', 'Гинеколог', 'Удаление ВМС за проводник'),
             ('Салюк Л.С.', 'Гинеколог', 'УЗИ беременные с 14 по 28 недель'),
             ('Салюк Л.С.', 'Гинеколог', 'УЗИ беременные с 30 недели'),
             ('Малышева Н.Ф.', 'Дерматовенеролог', 'Консультация дерматовенеролога'),
             ('Малышева Н.Ф.', 'Дерматовенеролог', 'Азот ладони'),
             ('Малышева Н.Ф.', 'Дерматовенеролог', 'Азот лицо'),
             ('Малышева Н.Ф.', 'Дерматовенеролог', 'Азот туловище'),
             ('Суханова Е.Г.', 'Кардиолог', 'ЭКГ с описанием'),
             ('Суханова Е.Г.', 'Кардиолог', 'ЭХО КГ'),
             ('Невоструев А.В.', 'Массажист', 'Массаж спины'),
             ('Невоструев А.В.', 'Массажист', 'Общий массаж'),
             ('Горшков А.В.', 'Невролог', 'Блокада'),
             ('Горшков А.В.', 'Невролог', 'Консультация невролога'),
             ('Смирнов С.В.', 'Оториноларинголог', 'Внутриносовая блокада'),
             ('Смирнов С.В.', 'Оториноларинголог', 'Снятие швов лицо'),
             ('Долженко Г.С.', 'Терапевт', 'Врачебная комиссия'),
             ('Долженко Г.С.', 'Терапевт', 'Выписка из амбулаторной карты'),
             ('Горшков А.В.', 'Травматолог', 'Травматолог-ортопед'),
             ('Горшков А.В.', 'Травматолог', 'Блокады травматолога (в т.ч. внутрисуставные)'),
             ('Борцов М.Ю.', 'УЗИ', 'УЗИ лимфоузлы'),
             ('Борцов М.Ю.', 'УЗИ', 'УЗИ ОМТ (дети)'),
             ('Борцов М.Ю.', 'УЗИ', 'УЗИ Слюнные железы'),
             ('Башлачёв В.А.', 'Уролог', 'Урофлуометрия'),
             ('Башлачёв В.А.', 'Уролог', 'Консультация уролога'),
             ('Борцов М.Ю.', 'Хирург', 'Перевязка'),
             ('Борцов М.Ю.', 'Хирург', 'Консультация хирурга'),
             ('Ароян С.А.', 'Эндокринолог', 'Пункционная биопсия щ/ж 1 зона'),
             ('Ароян С.А.', 'Эндокринолог', 'Пункционная биопсия щ/ж 2 зоны')]
        connection.executemany(
            "INSERT INTO doctor_services (doctor_id, service_id) VALUES (?, ?)",
            [(doctor_map[(d, specialty)], service_map[s]) for d, specialty, s in links if (d, specialty) in doctor_map and s in service_map],
        )
...
def save_doctor_image(image_data, image_name):
    if not image_data:
        return "uploads/doctors/doctor-1779290833944.jpg"
...
def save_service_image(image_data, image_name):
    if not image_data:
        return "uploads/services/service-1779287199986.png"
